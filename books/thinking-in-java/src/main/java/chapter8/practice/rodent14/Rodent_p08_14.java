package chapter8.practice.rodent14;
 ...
 * reference counting, and demonstrate that its works properly
 * @author lh
 */
class RandomRodentGenerator{
    // same shared object to be passed to every Rodnt:
